...
## When to Invoke
- **Before every trade cycle** — run `python3 ~/hanshermesagent/tools/drawdown_monitor.py check` before research, critic, or execution.
...
1. Run:
   ```bash
   python3 ~/hanshermesagent/tools/drawdown_monitor.py check
   ```
